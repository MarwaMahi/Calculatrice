 ...
 * @author microo
 */
public class CalculatorController1 implements Initializable {
    ...
    @FXML
     ...
     @FXML
      ...
      public void  getvergule(ActionEvent event) throws IOException{
        txF.setText(txF.getText()+bp.getText());
                  ...
                  @FXML
      public void  getMod(ActionEvent event) throws IOException{
        txF.setText(txF.getText()+bm.getText());
    }
               @FXML
     ...
     @FXML
      public void expon(ActionEvent event) throws IOException{
          Double x = m.expo(txF.getText());
      ...
      public void egal(ActionEvent event) throws IOException{
         ...
         txF.setText(Double.toString(x));
                    ...
                    @FXML
      public void sin(ActionEvent event) throws IOException{
          Double x = m.sin(txF.getText());
          txF.setText(Double.toString(x));
    }
                        @FXML
      public void cos(ActionEvent event) throws IOException{
           Double x = m.cos(txF.getText());
          txF.setText(Double.toString(x));  
    }
                            @FXML
      public void tan(ActionEvent event) throws IOException{
          Double x = m.tan(txF.getText());
          txF.setText(Double.toString(x));  
    }
      @FXML
      public void Pi(ActionEvent event) throws IOException{
          String x = m.pi();
          txF.setText(x);
      }
    ...
    public void initialize(URL url, ResourceBundle rb) {
       ...
       idHamb.addEventHandler(MouseEvent.MOUSE_PRESSED, new EventHandler<MouseEvent>() {
           ...
           public void handle(MouseEvent e) {
            ...
            Logger.getLogger(CalculatorController1.class.getName()).log(Level.SEVERE, null, ex);
        }
